...
interface SkeletonEcomProductGridShimmerProps {
  className?: string;
}

export function SkeletonEcomProductGridShimmer({ className }: SkeletonEcomProductGridShimmerProps) {
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-2">
              <h4 className="text-sm font-semibold text-[var(--foreground)] truncate">
                Skeleton Ecom Product Grid Shimmer
              </h4>
            ...
            <p className="text-xs text-[var(--muted-foreground)] line-clamp-1 mt-0.5">
              Shopping catalog product card wireframe with price, image, and star rating stubs.
            </p>
          </div>
        </div>
