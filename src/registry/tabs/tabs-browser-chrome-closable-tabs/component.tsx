...
interface TabsBrowserChromeClosableTabsProps {
  className?: string;
}

export function TabsBrowserChromeClosableTabs({ className }: TabsBrowserChromeClosableTabsProps) {
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-2">
              <h4 className="text-sm font-semibold text-[var(--foreground)] truncate">
                Tabs Browser Chrome Closable Tabs
              </h4>
            ...
            <p className="text-xs text-[var(--muted-foreground)] line-clamp-1 mt-0.5">
              Modern browser tab bar with close icons, new tab plus button, and active tab shadow.
            </p>
          </div>
        </div>
