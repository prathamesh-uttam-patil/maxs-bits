...
interface TabsVerticalIconSidebarShelfProps {
  className?: string;
}

export function TabsVerticalIconSidebarShelf({ className }: TabsVerticalIconSidebarShelfProps) {
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-2">
              <h4 className="text-sm font-semibold text-[var(--foreground)] truncate">
                Tabs Vertical Icon Sidebar Shelf
              </h4>
            ...
            <p className="text-xs text-[var(--muted-foreground)] line-clamp-1 mt-0.5">
              Vertical side tab strip with icon tooltips and indicator bar.
            </p>
          </div>
        </div>
