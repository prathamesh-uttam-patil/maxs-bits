...
interface TabsDockedPillSlidingGliderProps {
  className?: string;
}

export function TabsDockedPillSlidingGlider({ className }: TabsDockedPillSlidingGliderProps) {
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-2">
              <h4 className="text-sm font-semibold text-[var(--foreground)] truncate">
                Tabs Docked Pill Sliding Glider
              </h4>
            ...
            <p className="text-xs text-[var(--muted-foreground)] line-clamp-1 mt-0.5">
              Segmented control tab bar with smooth physical glider background animation.
            </p>
          </div>
        </div>
