...
interface ToggleDarkLightSunBeamProps {
  className?: string;
}

export function ToggleDarkLightSunBeam({ className }: ToggleDarkLightSunBeamProps) {
        ...
        <div className="flex items-center gap-3 min-w-0">
          ...
          <div className="min-w-0">
            ...
            <p className="text-xs text-[var(--muted-foreground)] line-clamp-1 mt-0.5">
              Dynamic solar ray toggle morphing between luminous sunbeams and crescent moon.
            </p>
          </div>
        </div>
