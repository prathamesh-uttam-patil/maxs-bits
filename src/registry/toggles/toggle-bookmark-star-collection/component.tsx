...
interface ToggleBookmarkStarCollectionProps {
  className?: string;
}

export function ToggleBookmarkStarCollection({ className }: ToggleBookmarkStarCollectionProps) {
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-2">
              <h4 className="text-sm font-semibold text-[var(--foreground)] truncate">
                Toggle Bookmark Star Collection
              </h4>
            ...
            <p className="text-xs text-[var(--muted-foreground)] line-clamp-1 mt-0.5">
              Favorite bookmark toggle with 3D star explosion and glowing outline.
            </p>
          </div>
        </div>
