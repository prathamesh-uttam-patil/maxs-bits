...
interface ToggleGridListLayoutSwitcherProps {
  className?: string;
}

export function ToggleGridListLayoutSwitcher({ className }: ToggleGridListLayoutSwitcherProps) {
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-2">
              <h4 className="text-sm font-semibold text-[var(--foreground)] truncate">
                Toggle Grid List Layout Switcher
              </h4>
            ...
            <p className="text-xs text-[var(--muted-foreground)] line-clamp-1 mt-0.5">
              Catalog layout transformer morphing between 2x2 grid blocks and horizontal row bars.
            </p>
          </div>
        </div>
