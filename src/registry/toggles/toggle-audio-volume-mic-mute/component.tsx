...
interface ToggleAudioVolumeMicMuteProps {
  className?: string;
}

export function ToggleAudioVolumeMicMute({ className }: ToggleAudioVolumeMicMuteProps) {
        ...
        <div className="flex items-center gap-3 min-w-0">
          ...
          <div className="min-w-0">
            ...
            <p className="text-xs text-[var(--muted-foreground)] line-clamp-1 mt-0.5">
              Conference mic mute button with animated slash waveform and red mute ring.
            </p>
          </div>
        </div>
