...
interface BackgroundFloatingGeometricShapesProps {
  className?: string;
}

export function BackgroundFloatingGeometricShapes({ className }: BackgroundFloatingGeometricShapesProps) {
        ...
        <div className="flex items-center gap-3 min-w-0">
          ...
          <div className="min-w-0">
            ...
            <p className="text-xs text-[var(--muted-foreground)] line-clamp-1 mt-0.5">
              Ethereal floating cubes, cones, and spheres with smooth ambient motion.
            </p>
          </div>
        </div>
