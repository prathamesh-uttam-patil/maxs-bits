...
interface BackgroundDeepSpaceStarfieldWarpProps {
  className?: string;
}

export function BackgroundDeepSpaceStarfieldWarp({ className }: BackgroundDeepSpaceStarfieldWarpProps) {
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-2">
              <h4 className="text-sm font-semibold text-[var(--foreground)] truncate">
                Background Deep Space Starfield Warp
              </h4>
            ...
            <p className="text-xs text-[var(--muted-foreground)] line-clamp-1 mt-0.5">
              Twinkling cosmos starfield with subtle nebula dust clouds and drift effect.
            </p>
          </div>
        </div>
