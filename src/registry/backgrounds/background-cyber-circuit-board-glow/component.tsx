...
interface BackgroundCyberCircuitBoardGlowProps {
  className?: string;
}

export function BackgroundCyberCircuitBoardGlow({ className }: BackgroundCyberCircuitBoardGlowProps) {
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-2">
              <h4 className="text-sm font-semibold text-[var(--foreground)] truncate">
                Background Cyber Circuit Board Glow
              </h4>
            ...
            <p className="text-xs text-[var(--muted-foreground)] line-clamp-1 mt-0.5">
              Futuristic PCB circuit board traces with flowing digital pulse nodes.
            </p>
          </div>
        </div>
