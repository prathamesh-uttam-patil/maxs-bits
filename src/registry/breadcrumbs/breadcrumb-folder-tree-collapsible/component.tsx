...
interface BreadcrumbFolderTreeCollapsibleProps {
  className?: string;
}

export function BreadcrumbFolderTreeCollapsible({ className }: BreadcrumbFolderTreeCollapsibleProps) {
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-2">
              <h4 className="text-sm font-semibold text-[var(--foreground)] truncate">
                Breadcrumb Folder Tree Collapsible
              </h4>
            ...
            <p className="text-xs text-[var(--muted-foreground)] line-clamp-1 mt-0.5">
              File manager breadcrumb with dropdown parent folder picker for long paths.
            </p>
          </div>
        </div>
