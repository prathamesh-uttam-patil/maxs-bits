...
interface BreadcrumbSteppedProgressCrumbProps {
  className?: string;
}

export function BreadcrumbSteppedProgressCrumb({ className }: BreadcrumbSteppedProgressCrumbProps) {
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-2">
              <h4 className="text-sm font-semibold text-[var(--foreground)] truncate">
                Breadcrumb Stepped Progress Crumb
              </h4>
            ...
            <p className="text-xs text-[var(--muted-foreground)] line-clamp-1 mt-0.5">
              Checkout flow breadcrumb combining hierarchical pathing with completion percentages.
            </p>
          </div>
        </div>
