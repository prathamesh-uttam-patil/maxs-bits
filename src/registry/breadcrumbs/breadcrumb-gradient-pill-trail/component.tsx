...
interface BreadcrumbGradientPillTrailProps {
  className?: string;
}

export function BreadcrumbGradientPillTrail({ className }: BreadcrumbGradientPillTrailProps) {
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-2">
              <h4 className="text-sm font-semibold text-[var(--foreground)] truncate">
                Breadcrumb Gradient Pill Trail
              </h4>
            ...
            <p className="text-xs text-[var(--muted-foreground)] line-clamp-1 mt-0.5">
              Capsule shaped breadcrumb trail connected by gradient micro-chevrons.
            </p>
          </div>
        </div>
