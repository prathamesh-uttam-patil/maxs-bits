...
interface BreadcrumbSlashMinimalGlowProps {
  className?: string;
}

export function BreadcrumbSlashMinimalGlow({ className }: BreadcrumbSlashMinimalGlowProps) {
        ...
        <div className="flex items-center gap-3 min-w-0">
          ...
          <div className="min-w-0">
            ...
            <p className="text-xs text-[var(--muted-foreground)] line-clamp-1 mt-0.5">
              Clean slanted slash navigation breadcrumb with hover glow effect on segment items.
            </p>
          </div>
        </div>
