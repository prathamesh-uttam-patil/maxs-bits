...
interface DockRadialFanLauncherProps {
  className?: string;
}

export function DockRadialFanLauncher({ className }: DockRadialFanLauncherProps) {
        ...
        <div className="flex items-center gap-3 min-w-0">
          ...
          <div className="min-w-0">
            ...
            <p className="text-xs text-[var(--muted-foreground)] line-clamp-1 mt-0.5">
              Corner-docked radial fan launcher expanding items in a smooth arc.
            </p>
          </div>
        </div>
