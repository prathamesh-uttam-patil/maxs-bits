...
interface DockMagnificationPreviewBarProps {
  className?: string;
}

export function DockMagnificationPreviewBar({ className }: DockMagnificationPreviewBarProps) {
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-2">
              <h4 className="text-sm font-semibold text-[var(--foreground)] truncate">
                Dock Magnification Preview Bar
              </h4>
            ...
            <p className="text-xs text-[var(--muted-foreground)] line-clamp-1 mt-0.5">
              macOS style magnification dock with floating tooltip and dynamic scale transforms.
            </p>
          </div>
        </div>
