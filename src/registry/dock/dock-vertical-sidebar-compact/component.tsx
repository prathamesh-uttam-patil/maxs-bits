...
interface DockVerticalSidebarCompactProps {
  className?: string;
}

export function DockVerticalSidebarCompact({ className }: DockVerticalSidebarCompactProps) {
        ...
        <div className="flex items-center gap-3 min-w-0">
          ...
          <div className="min-w-0">
            ...
            <p className="text-xs text-[var(--muted-foreground)] line-clamp-1 mt-0.5">
              Vertical side-anchored dock launcher with flyout labels and badge counter.
            </p>
          </div>
        </div>
