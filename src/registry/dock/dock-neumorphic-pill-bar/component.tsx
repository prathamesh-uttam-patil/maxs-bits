...
interface DockNeumorphicPillBarProps {
  className?: string;
}

export function DockNeumorphicPillBar({ className }: DockNeumorphicPillBarProps) {
        ...
        <div className="flex items-center gap-3 min-w-0">
          ...
          <div className="min-w-0">
            ...
            <p className="text-xs text-[var(--muted-foreground)] line-clamp-1 mt-0.5">
              Soft shadow extruded pill dock with tactile press states and glow highlights.
            </p>
          </div>
        </div>
