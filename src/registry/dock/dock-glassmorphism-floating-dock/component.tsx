...
interface DockGlassmorphismFloatingDockProps {
  className?: string;
}

export function DockGlassmorphismFloatingDock({ className }: DockGlassmorphismFloatingDockProps) {
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-2">
              <h4 className="text-sm font-semibold text-[var(--foreground)] truncate">
                Dock Glassmorphism Floating Dock
              </h4>
            ...
            <p className="text-xs text-[var(--muted-foreground)] line-clamp-1 mt-0.5">
              Frosted glass floating app dock with active dot indicator and bounce reflection.
            </p>
          </div>
        </div>
