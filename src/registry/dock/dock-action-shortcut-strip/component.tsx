...
interface DockActionShortcutStripProps {
  className?: string;
}

export function DockActionShortcutStrip({ className }: DockActionShortcutStripProps) {
        ...
        <div className="flex items-center gap-3 min-w-0">
          ...
          <div className="min-w-0">
            ...
            <p className="text-xs text-[var(--muted-foreground)] line-clamp-1 mt-0.5">
              Quick command action strip with keyboard trigger shortcuts and status pills.
            </p>
          </div>
        </div>
