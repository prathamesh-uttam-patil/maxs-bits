...
interface KbdMechanicalSwitchKeycapProps {
  className?: string;
}

export function KbdMechanicalSwitchKeycap({ className }: KbdMechanicalSwitchKeycapProps) {
        ...
        <div className="flex items-center gap-3 min-w-0">
          ...
          <div className="min-w-0">
            ...
            <p className="text-xs text-[var(--muted-foreground)] line-clamp-1 mt-0.5">
              3D cherry MX mechanical keycap with tactile depression physics and switch click.
            </p>
          </div>
        </div>
