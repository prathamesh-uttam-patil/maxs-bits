...
interface KbdInteractivePianoTriggerProps {
  className?: string;
}

export function KbdInteractivePianoTrigger({ className }: KbdInteractivePianoTriggerProps) {
        ...
        <div className="flex items-center gap-3 min-w-0">
          ...
          <div className="min-w-0">
            ...
            <p className="text-xs text-[var(--muted-foreground)] line-clamp-1 mt-0.5">
              Musical keyboard hotkey note with audible tone resonance and active press animation.
            </p>
          </div>
        </div>
