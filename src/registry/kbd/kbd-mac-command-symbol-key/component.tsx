...
interface KbdMacCommandSymbolKeyProps {
  className?: string;
}

export function KbdMacCommandSymbolKey({ className }: KbdMacCommandSymbolKeyProps) {
        ...
        <div className="flex items-center gap-3 min-w-0">
          ...
          <div className="min-w-0">
            ...
            <p className="text-xs text-[var(--muted-foreground)] line-clamp-1 mt-0.5">
              Apple aluminium finish keyboard keycaps featuring Command, Option, and Control symbols.
            </p>
          </div>
        </div>
