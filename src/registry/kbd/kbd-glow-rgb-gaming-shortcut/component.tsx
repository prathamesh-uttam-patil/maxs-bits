...
interface KbdGlowRgbGamingShortcutProps {
  className?: string;
}

export function KbdGlowRgbGamingShortcut({ className }: KbdGlowRgbGamingShortcutProps) {
        ...
        <div className="flex items-center gap-3 min-w-0">
          ...
          <div className="min-w-0">
            ...
            <p className="text-xs text-[var(--muted-foreground)] line-clamp-1 mt-0.5">
              Chroma animated RGB hotkey badge with animated rainbow underglow.
            </p>
          </div>
        </div>
