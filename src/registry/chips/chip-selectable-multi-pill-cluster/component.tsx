...
interface ChipSelectableMultiPillClusterProps {
  className?: string;
}

export function ChipSelectableMultiPillCluster({ className }: ChipSelectableMultiPillClusterProps) {
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-2">
              <h4 className="text-sm font-semibold text-[var(--foreground)] truncate">
                Chip Selectable Multi Pill Cluster
              </h4>
            ...
            <p className="text-xs text-[var(--muted-foreground)] line-clamp-1 mt-0.5">
              Category preference selector with checked checkmark transition and spring effect.
            </p>
          </div>
        </div>
