...
interface ChipDiscountCouponCodePillProps {
  className?: string;
}

export function ChipDiscountCouponCodePill({ className }: ChipDiscountCouponCodePillProps) {
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-2">
              <h4 className="text-sm font-semibold text-[var(--foreground)] truncate">
                Chip Discount Coupon Code Pill
              </h4>
            ...
            <p className="text-xs text-[var(--muted-foreground)] line-clamp-1 mt-0.5">
              Promo voucher chip with dashed border and one-click copy code feedback.
            </p>
          </div>
        </div>
