...
interface ChipRemovableFilterTagPillProps {
  className?: string;
}

export function ChipRemovableFilterTagPill({ className }: ChipRemovableFilterTagPillProps) {
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-2">
              <h4 className="text-sm font-semibold text-[var(--foreground)] truncate">
                Chip Removable Filter Tag Pill
              </h4>
            ...
            <p className="text-xs text-[var(--muted-foreground)] line-clamp-1 mt-0.5">
              Interactive search filter chip with clear X button and hover highlight.
            </p>
          </div>
        </div>
