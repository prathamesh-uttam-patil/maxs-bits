...
interface ChipUserPresenceAvatarBadgeProps {
  className?: string;
}

export function ChipUserPresenceAvatarBadge({ className }: ChipUserPresenceAvatarBadgeProps) {
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-2">
              <h4 className="text-sm font-semibold text-[var(--foreground)] truncate">
                Chip User Presence Avatar Badge
              </h4>
            ...
            <p className="text-xs text-[var(--muted-foreground)] line-clamp-1 mt-0.5">
              Compact collaborator chip with live online status dot and micro avatar.
            </p>
          </div>
        </div>
