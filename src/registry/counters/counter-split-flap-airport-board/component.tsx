...
interface CounterSplitFlapAirportBoardProps {
  className?: string;
}

export function CounterSplitFlapAirportBoard({ className }: CounterSplitFlapAirportBoardProps) {
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-2">
              <h4 className="text-sm font-semibold text-[var(--foreground)] truncate">
                Counter Split Flap Airport Board
              </h4>
            ...
            <p className="text-xs text-[var(--muted-foreground)] line-clamp-1 mt-0.5">
              Mechanical solari split-flap departure board with flipping alphabet tiles.
            </p>
          </div>
        </div>
