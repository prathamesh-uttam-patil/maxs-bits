...
interface CounterNixieTubeGlowingClockProps {
  className?: string;
}

export function CounterNixieTubeGlowingClock({ className }: CounterNixieTubeGlowingClockProps) {
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-2">
              <h4 className="text-sm font-semibold text-[var(--foreground)] truncate">
                Counter Nixie Tube Glowing Clock
              </h4>
            ...
            <p className="text-xs text-[var(--muted-foreground)] line-clamp-1 mt-0.5">
              Warm orange vacuum nixie tubes displaying counting digits with filament wire filaments.
            </p>
          </div>
        </div>
