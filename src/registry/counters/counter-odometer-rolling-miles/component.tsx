...
interface CounterOdometerRollingMilesProps {
  className?: string;
}

export function CounterOdometerRollingMiles({ className }: CounterOdometerRollingMilesProps) {
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-2">
              <h4 className="text-sm font-semibold text-[var(--foreground)] truncate">
                Counter Odometer Rolling Miles
              </h4>
            ...
            <p className="text-xs text-[var(--muted-foreground)] line-clamp-1 mt-0.5">
              Vintage automobile odometer with continuous rolling vertical barrel digits.
            </p>
          </div>
        </div>
