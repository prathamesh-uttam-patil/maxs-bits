...
interface RatingCoffeeCupFillLevelProps {
  className?: string;
}

export function RatingCoffeeCupFillLevel({ className }: RatingCoffeeCupFillLevelProps) {
        ...
        <div className="flex items-center gap-3 min-w-0">
          ...
          <div className="min-w-0">
            ...
            <p className="text-xs text-[var(--muted-foreground)] line-clamp-1 mt-0.5">
              Whimsical coffee cup rating filling with hot brew and rising steam particles.
            </p>
          </div>
        </div>
