...
interface RatingAnimatedHeartBurstCounterProps {
  className?: string;
}

export function RatingAnimatedHeartBurstCounter({ className }: RatingAnimatedHeartBurstCounterProps) {
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-2">
              <h4 className="text-sm font-semibold text-[var(--foreground)] truncate">
                Rating Animated Heart Burst Counter
              </h4>
            ...
            <p className="text-xs text-[var(--muted-foreground)] line-clamp-1 mt-0.5">
              Twitter-like floating heart reaction burst with particle explosion effect.
            </p>
          </div>
        </div>
