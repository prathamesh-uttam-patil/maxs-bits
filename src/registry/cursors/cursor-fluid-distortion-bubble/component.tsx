...
interface CursorFluidDistortionBubbleProps {
  className?: string;
}

export function CursorFluidDistortionBubble({ className }: CursorFluidDistortionBubbleProps) {
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-2">
              <h4 className="text-sm font-semibold text-[var(--foreground)] truncate">
                Cursor Fluid Distortion Bubble
              </h4>
            ...
            <p className="text-xs text-[var(--muted-foreground)] line-clamp-1 mt-0.5">
              Liquid magnification lens following cursor and refracting underlying content.
            </p>
          </div>
        </div>
