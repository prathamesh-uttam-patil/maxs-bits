...
interface CursorMagneticButtonSnapperProps {
  className?: string;
}

export function CursorMagneticButtonSnapper({ className }: CursorMagneticButtonSnapperProps) {
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-2">
              <h4 className="text-sm font-semibold text-[var(--foreground)] truncate">
                Cursor Magnetic Button Snapper
              </h4>
            ...
            <p className="text-xs text-[var(--muted-foreground)] line-clamp-1 mt-0.5">
              Smart cursor dot snapping magnetically to interactive buttons and clickable targets.
            </p>
          </div>
        </div>
