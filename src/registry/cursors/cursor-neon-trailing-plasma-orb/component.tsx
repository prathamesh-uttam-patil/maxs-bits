...
interface CursorNeonTrailingPlasmaOrbProps {
  className?: string;
}

export function CursorNeonTrailingPlasmaOrb({ className }: CursorNeonTrailingPlasmaOrbProps) {
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-2">
              <h4 className="text-sm font-semibold text-[var(--foreground)] truncate">
                Cursor Neon Trailing Plasma Orb
              </h4>
            ...
            <p className="text-xs text-[var(--muted-foreground)] line-clamp-1 mt-0.5">
              Glowing plasma sphere that trails cursor motion with elastic inertia smoothing.
            </p>
          </div>
        </div>
