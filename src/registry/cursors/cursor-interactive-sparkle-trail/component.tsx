...
interface CursorInteractiveSparkleTrailProps {
  className?: string;
}

export function CursorInteractiveSparkleTrail({ className }: CursorInteractiveSparkleTrailProps) {
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-2">
              <h4 className="text-sm font-semibold text-[var(--foreground)] truncate">
                Cursor Interactive Sparkle Trail
              </h4>
            ...
            <p className="text-xs text-[var(--muted-foreground)] line-clamp-1 mt-0.5">
              Fairy dust sparkle particle explosion spawning behind rapid pointer velocities.
            </p>
          </div>
        </div>
