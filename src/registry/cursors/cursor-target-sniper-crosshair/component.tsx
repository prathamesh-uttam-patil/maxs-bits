...
interface CursorTargetSniperCrosshairProps {
  className?: string;
}

export function CursorTargetSniperCrosshair({ className }: CursorTargetSniperCrosshairProps) {
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-2">
              <h4 className="text-sm font-semibold text-[var(--foreground)] truncate">
                Cursor Target Sniper Crosshair
              </h4>
            ...
            <p className="text-xs text-[var(--muted-foreground)] line-clamp-1 mt-0.5">
              Precision tactical HUD crosshair with rotating coordinate rings and target lock.
            </p>
          </div>
        </div>
