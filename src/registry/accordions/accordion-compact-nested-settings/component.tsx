...
interface AccordionCompactNestedSettingsProps {
  className?: string;
}

export function AccordionCompactNestedSettings({ className }: AccordionCompactNestedSettingsProps) {
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-2">
              <h4 className="text-sm font-semibold text-[var(--foreground)] truncate">
                Accordion Compact Nested Settings
              </h4>
            ...
            <p className="text-xs text-[var(--muted-foreground)] line-clamp-1 mt-0.5">
              Preference configuration accordion with nested toggles and granular permission levels.
            </p>
          </div>
        </div>
