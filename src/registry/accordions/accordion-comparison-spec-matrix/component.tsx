...
interface AccordionComparisonSpecMatrixProps {
  className?: string;
}

export function AccordionComparisonSpecMatrix({ className }: AccordionComparisonSpecMatrixProps) {
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-2">
              <h4 className="text-sm font-semibold text-[var(--foreground)] truncate">
                Accordion Comparison Spec Matrix
              </h4>
            ...
            <p className="text-xs text-[var(--muted-foreground)] line-clamp-1 mt-0.5">
              Product feature comparison accordion highlighting differences with badge indicators.
            </p>
          </div>
        </div>
