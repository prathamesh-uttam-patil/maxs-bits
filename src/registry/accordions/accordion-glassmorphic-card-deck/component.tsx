...
interface AccordionGlassmorphicCardDeckProps {
  className?: string;
}

export function AccordionGlassmorphicCardDeck({ className }: AccordionGlassmorphicCardDeckProps) {
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-2">
              <h4 className="text-sm font-semibold text-[var(--foreground)] truncate">
                Accordion Glassmorphic Card Deck
              </h4>
            ...
            <p className="text-xs text-[var(--muted-foreground)] line-clamp-1 mt-0.5">
              Layered frosted glass FAQ cards that smoothly unstack and expand on selection.
            </p>
          </div>
        </div>
