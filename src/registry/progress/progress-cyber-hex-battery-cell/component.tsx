...
interface ProgressCyberHexBatteryCellProps {
  className?: string;
}

export function ProgressCyberHexBatteryCell({ className }: ProgressCyberHexBatteryCellProps) {
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-2">
              <h4 className="text-sm font-semibold text-[var(--foreground)] truncate">
                Progress Cyber Hex Battery Cell
              </h4>
            ...
            <p className="text-xs text-[var(--muted-foreground)] line-clamp-1 mt-0.5">
              Futuristic hexagon power cell meter with charging neon energy bars.
            </p>
          </div>
        </div>
