...
interface ProgressCircularConcentricRingsProps {
  className?: string;
}

export function ProgressCircularConcentricRings({ className }: ProgressCircularConcentricRingsProps) {
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-2">
              <h4 className="text-sm font-semibold text-[var(--foreground)] truncate">
                Progress Circular Concentric Rings
              </h4>
            ...
            <p className="text-xs text-[var(--muted-foreground)] line-clamp-1 mt-0.5">
              Apple Watch style 3-ring fitness tracker showing calories, exercise, and stand goals.
            </p>
          </div>
        </div>
