...
interface ProgressGradientLiquidFillBeakerProps {
  className?: string;
}

export function ProgressGradientLiquidFillBeaker({ className }: ProgressGradientLiquidFillBeakerProps) {
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-2">
              <h4 className="text-sm font-semibold text-[var(--foreground)] truncate">
                Progress Gradient Liquid Fill Beaker
              </h4>
            ...
            <p className="text-xs text-[var(--muted-foreground)] line-clamp-1 mt-0.5">
              Laboratory flask indicator filling with bubbling colorful chemical liquid.
            </p>
          </div>
        </div>
