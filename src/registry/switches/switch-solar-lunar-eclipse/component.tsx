...
interface SwitchSolarLunarEclipseProps {
  className?: string;
}

export function SwitchSolarLunarEclipse({ className }: SwitchSolarLunarEclipseProps) {
        ...
        <div className="flex items-center gap-3 min-w-0">
          ...
          <div className="min-w-0">
            ...
            <p className="text-xs text-[var(--muted-foreground)] line-clamp-1 mt-0.5">
              Day/Night switch transforming from glowing sun to cratered moon eclipse.
            </p>
          </div>
        </div>
