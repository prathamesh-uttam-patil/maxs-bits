...
interface SwitchMagneticSnapFlickerProps {
  className?: string;
}

export function SwitchMagneticSnapFlicker({ className }: SwitchMagneticSnapFlickerProps) {
        ...
        <div className="flex items-center gap-3 min-w-0">
          ...
          <div className="min-w-0">
            ...
            <p className="text-xs text-[var(--muted-foreground)] line-clamp-1 mt-0.5">
              Snappy magnetic tactile toggle switch with haptic vibration indicator.
            </p>
          </div>
        </div>
