...
interface SwitchLiquidSlimeBubbleProps {
  className?: string;
}

export function SwitchLiquidSlimeBubble({ className }: SwitchLiquidSlimeBubbleProps) {
        ...
        <div className="flex items-center gap-3 min-w-0">
          ...
          <div className="min-w-0">
            ...
            <p className="text-xs text-[var(--muted-foreground)] line-clamp-1 mt-0.5">
              Fluid physics toggle with gooey slime transition between on and off states.
            </p>
          </div>
        </div>
