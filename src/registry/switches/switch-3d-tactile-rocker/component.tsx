...
interface Switch3dTactileRockerProps {
  className?: string;
}

export function Switch3dTactileRocker({ className }: Switch3dTactileRockerProps) {
        ...
        <div className="flex items-center gap-3 min-w-0">
          ...
          <div className="min-w-0">
            ...
            <p className="text-xs text-[var(--muted-foreground)] line-clamp-1 mt-0.5">
              Realistic skeuomorphic rocker power switch with physical shadow depression.
            </p>
          </div>
        </div>
