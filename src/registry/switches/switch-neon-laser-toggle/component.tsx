...
interface SwitchNeonLaserToggleProps {
  className?: string;
}

export function SwitchNeonLaserToggle({ className }: SwitchNeonLaserToggleProps) {
        ...
        <div className="flex items-center gap-3 min-w-0">
          ...
          <div className="min-w-0">
            ...
            <p className="text-xs text-[var(--muted-foreground)] line-clamp-1 mt-0.5">
              Cyberpunk style glowing neon toggle switch with intense laser beam channel.
            </p>
          </div>
        </div>
