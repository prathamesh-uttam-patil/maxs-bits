...
interface MarqueeStockTickerTapeLiveProps {
  className?: string;
}

export function MarqueeStockTickerTapeLive({ className }: MarqueeStockTickerTapeLiveProps) {
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-2">
              <h4 className="text-sm font-semibold text-[var(--foreground)] truncate">
                Marquee Stock Ticker Tape Live
              </h4>
            ...
            <p className="text-xs text-[var(--muted-foreground)] line-clamp-1 mt-0.5">
              Wall Street financial ticker with green gains, red dips, and fluctuating percentages.
            </p>
          </div>
        </div>
