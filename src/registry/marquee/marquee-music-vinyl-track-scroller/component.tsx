...
interface MarqueeMusicVinylTrackScrollerProps {
  className?: string;
}

export function MarqueeMusicVinylTrackScroller({ className }: MarqueeMusicVinylTrackScrollerProps) {
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-2">
              <h4 className="text-sm font-semibold text-[var(--foreground)] truncate">
                Marquee Music Vinyl Track Scroller
              </h4>
            ...
            <p className="text-xs text-[var(--muted-foreground)] line-clamp-1 mt-0.5">
              Now playing scroller synced with spinning vinyl record and equalizer bars.
            </p>
          </div>
        </div>
