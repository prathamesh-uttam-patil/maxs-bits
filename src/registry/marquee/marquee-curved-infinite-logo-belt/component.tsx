...
interface MarqueeCurvedInfiniteLogoBeltProps {
  className?: string;
}

export function MarqueeCurvedInfiniteLogoBelt({ className }: MarqueeCurvedInfiniteLogoBeltProps) {
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-2">
              <h4 className="text-sm font-semibold text-[var(--foreground)] truncate">
                Marquee Curved Infinite Logo Belt
              </h4>
            ...
            <p className="text-xs text-[var(--muted-foreground)] line-clamp-1 mt-0.5">
              Perspective angled conveyor belt showcasing partner brand logos infinitely.
            </p>
          </div>
        </div>
