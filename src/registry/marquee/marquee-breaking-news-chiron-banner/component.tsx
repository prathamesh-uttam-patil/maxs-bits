...
interface MarqueeBreakingNewsChironBannerProps {
  className?: string;
}

export function MarqueeBreakingNewsChironBanner({ className }: MarqueeBreakingNewsChironBannerProps) {
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-2">
              <h4 className="text-sm font-semibold text-[var(--foreground)] truncate">
                Marquee Breaking News Chiron Banner
              </h4>
            ...
            <p className="text-xs text-[var(--muted-foreground)] line-clamp-1 mt-0.5">
              Broadcast TV news lower third with urgency badge and streaming headline ticker.
            </p>
          </div>
        </div>
