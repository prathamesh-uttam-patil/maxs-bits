...
interface ModalAudioFileWaveformEditorProps {
  className?: string;
}

export function ModalAudioFileWaveformEditor({ className }: ModalAudioFileWaveformEditorProps) {
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-2">
              <h4 className="text-sm font-semibold text-[var(--foreground)] truncate">
                Modal Audio File Waveform Editor
              </h4>
            ...
            <p className="text-xs text-[var(--muted-foreground)] line-clamp-1 mt-0.5">
              Sound clipping dialog with zoomable audio wave scrubber and playback trimmer.
            </p>
          </div>
        </div>
