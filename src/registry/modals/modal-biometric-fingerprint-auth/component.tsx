...
interface ModalBiometricFingerprintAuthProps {
  className?: string;
}

export function ModalBiometricFingerprintAuth({ className }: ModalBiometricFingerprintAuthProps) {
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-2">
              <h4 className="text-sm font-semibold text-[var(--foreground)] truncate">
                Modal Biometric Fingerprint Auth
              </h4>
            ...
            <p className="text-xs text-[var(--muted-foreground)] line-clamp-1 mt-0.5">
              Security authentication dialog with animated fingerprint scanner and success ring.
            </p>
          </div>
        </div>
