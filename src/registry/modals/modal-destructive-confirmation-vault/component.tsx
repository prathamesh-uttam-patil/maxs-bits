...
interface ModalDestructiveConfirmationVaultProps {
  className?: string;
}

export function ModalDestructiveConfirmationVault({ className }: ModalDestructiveConfirmationVaultProps) {
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-2">
              <h4 className="text-sm font-semibold text-[var(--foreground)] truncate">
                Modal Destructive Confirmation Vault
              </h4>
            ...
            <p className="text-xs text-[var(--muted-foreground)] line-clamp-1 mt-0.5">
              High security deletion confirmation modal requiring typing confirmation phrase.
            </p>
          </div>
        </div>
