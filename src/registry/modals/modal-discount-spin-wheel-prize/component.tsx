...
interface ModalDiscountSpinWheelPrizeProps {
  className?: string;
}

export function ModalDiscountSpinWheelPrize({ className }: ModalDiscountSpinWheelPrizeProps) {
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-2">
              <h4 className="text-sm font-semibold text-[var(--foreground)] truncate">
                Modal Discount Spin Wheel Prize
              </h4>
            ...
            <p className="text-xs text-[var(--muted-foreground)] line-clamp-1 mt-0.5">
              Gamified e-commerce modal with spinning roulette wheel for promo coupons.
            </p>
          </div>
        </div>
