...
interface ScrollHorizontalSnapCardRailProps {
  className?: string;
}

export function ScrollHorizontalSnapCardRail({ className }: ScrollHorizontalSnapCardRailProps) {
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-2">
              <h4 className="text-sm font-semibold text-[var(--foreground)] truncate">
                Scroll Horizontal Snap Card Rail
              </h4>
            ...
            <p className="text-xs text-[var(--muted-foreground)] line-clamp-1 mt-0.5">
              Touch-friendly swipeable carousel with CSS scroll snapping and arrow controls.
            </p>
          </div>
        </div>
