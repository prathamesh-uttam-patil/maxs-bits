...
interface ScrollFloatingBackToTopFabProps {
  className?: string;
}

export function ScrollFloatingBackToTopFab({ className }: ScrollFloatingBackToTopFabProps) {
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-2">
              <h4 className="text-sm font-semibold text-[var(--foreground)] truncate">
                Scroll Floating Back To Top FAB
              </h4>
            ...
            <p className="text-xs text-[var(--muted-foreground)] line-clamp-1 mt-0.5">
              Floating action button appearing on deep scroll with circular scroll progress ring.
            </p>
          </div>
        </div>
