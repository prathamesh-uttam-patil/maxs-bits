...
interface ScrollReadingProgressHeaderLineProps {
  className?: string;
}

export function ScrollReadingProgressHeaderLine({ className }: ScrollReadingProgressHeaderLineProps) {
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-2">
              <h4 className="text-sm font-semibold text-[var(--foreground)] truncate">
                Scroll Reading Progress Header Line
              </h4>
            ...
            <p className="text-xs text-[var(--muted-foreground)] line-clamp-1 mt-0.5">
              Article reading progress indicator tracking scroll depth across long documents.
            </p>
          </div>
        </div>
