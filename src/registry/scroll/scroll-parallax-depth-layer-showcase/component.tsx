...
interface ScrollParallaxDepthLayerShowcaseProps {
  className?: string;
}

export function ScrollParallaxDepthLayerShowcase({ className }: ScrollParallaxDepthLayerShowcaseProps) {
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-2">
              <h4 className="text-sm font-semibold text-[var(--foreground)] truncate">
                Scroll Parallax Depth Layer Showcase
              </h4>
            ...
            <p className="text-xs text-[var(--muted-foreground)] line-clamp-1 mt-0.5">
              Multi-layer 3D depth showcase with staggered parallax speed translations.
            </p>
          </div>
        </div>
