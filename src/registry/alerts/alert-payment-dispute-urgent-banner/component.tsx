...
interface AlertPaymentDisputeUrgentBannerProps {
  className?: string;
}

export function AlertPaymentDisputeUrgentBanner({ className }: AlertPaymentDisputeUrgentBannerProps) {
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-2">
              <h4 className="text-sm font-semibold text-[var(--foreground)] truncate">
                Alert Payment Dispute Urgent Banner
              </h4>
            ...
            <p className="text-xs text-[var(--muted-foreground)] line-clamp-1 mt-0.5">
              Billing notification card with countdown timer and one-click dispute resolution.
            </p>
          </div>
        </div>
