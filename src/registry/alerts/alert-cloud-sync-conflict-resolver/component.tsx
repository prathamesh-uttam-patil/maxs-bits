...
interface AlertCloudSyncConflictResolverProps {
  className?: string;
}

export function AlertCloudSyncConflictResolver({ className }: AlertCloudSyncConflictResolverProps) {
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-2">
              <h4 className="text-sm font-semibold text-[var(--foreground)] truncate">
                Alert Cloud Sync Conflict Resolver
              </h4>
            ...
            <p className="text-xs text-[var(--muted-foreground)] line-clamp-1 mt-0.5">
              File collision alert with side-by-side version chooser and keep both buttons.
            </p>
          </div>
        </div>
