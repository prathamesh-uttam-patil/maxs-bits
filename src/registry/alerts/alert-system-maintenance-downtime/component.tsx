...
interface AlertSystemMaintenanceDowntimeProps {
  className?: string;
}

export function AlertSystemMaintenanceDowntime({ className }: AlertSystemMaintenanceDowntimeProps) {
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-2">
              <h4 className="text-sm font-semibold text-[var(--foreground)] truncate">
                Alert System Maintenance Downtime
              </h4>
            ...
            <p className="text-xs text-[var(--muted-foreground)] line-clamp-1 mt-0.5">
              Scheduled platform maintenance banner with UTC time converter and status link.
            </p>
          </div>
        </div>
