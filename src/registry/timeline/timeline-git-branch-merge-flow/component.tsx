...
interface TimelineGitBranchMergeFlowProps {
  className?: string;
}

export function TimelineGitBranchMergeFlow({ className }: TimelineGitBranchMergeFlowProps) {
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-2">
              <h4 className="text-sm font-semibold text-[var(--foreground)] truncate">
                Timeline Git Branch Merge Flow
              </h4>
            ...
            <p className="text-xs text-[var(--muted-foreground)] line-clamp-1 mt-0.5">
              Interactive git commit tree with branch forks, tags, and commit hashes.
            </p>
          </div>
        </div>
