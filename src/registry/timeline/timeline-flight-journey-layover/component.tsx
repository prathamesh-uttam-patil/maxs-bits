...
interface TimelineFlightJourneyLayoverProps {
  className?: string;
}

export function TimelineFlightJourneyLayover({ className }: TimelineFlightJourneyLayoverProps) {
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-2">
              <h4 className="text-sm font-semibold text-[var(--foreground)] truncate">
                Timeline Flight Journey Layover
              </h4>
            ...
            <p className="text-xs text-[var(--muted-foreground)] line-clamp-1 mt-0.5">
              Multi-leg flight timeline with gate numbers, boarding times, and layover durations.
            </p>
          </div>
        </div>
