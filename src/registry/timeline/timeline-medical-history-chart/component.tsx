...
interface TimelineMedicalHistoryChartProps {
  className?: string;
}

export function TimelineMedicalHistoryChart({ className }: TimelineMedicalHistoryChartProps) {
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-2">
              <h4 className="text-sm font-semibold text-[var(--foreground)] truncate">
                Timeline Medical History Chart
              </h4>
            ...
            <p className="text-xs text-[var(--muted-foreground)] line-clamp-1 mt-0.5">
              Chronological clinical care timeline with prescription and diagnosis tags.
            </p>
          </div>
        </div>
