...
interface TimelineSprintKanbanMilestonesProps {
  className?: string;
}

export function TimelineSprintKanbanMilestones({ className }: TimelineSprintKanbanMilestonesProps) {
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-2">
              <h4 className="text-sm font-semibold text-[var(--foreground)] truncate">
                Timeline Sprint Kanban Milestones
              </h4>
            ...
            <p className="text-xs text-[var(--muted-foreground)] line-clamp-1 mt-0.5">
              Agile milestone progress timeline with velocity points and burndown indicators.
            </p>
          </div>
        </div>
