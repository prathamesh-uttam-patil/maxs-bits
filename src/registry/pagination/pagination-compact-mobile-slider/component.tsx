...
interface PaginationCompactMobileSliderProps {
  className?: string;
}

export function PaginationCompactMobileSlider({ className }: PaginationCompactMobileSliderProps) {
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-2">
              <h4 className="text-sm font-semibold text-[var(--foreground)] truncate">
                Pagination Compact Mobile Slider
              </h4>
            ...
            <p className="text-xs text-[var(--muted-foreground)] line-clamp-1 mt-0.5">
              Ultra space-efficient mobile pagination with drag slider and page indicator.
            </p>
          </div>
        </div>
