...
interface PaginationInfiniteDotScrubberProps {
  className?: string;
}

export function PaginationInfiniteDotScrubber({ className }: PaginationInfiniteDotScrubberProps) {
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-2">
              <h4 className="text-sm font-semibold text-[var(--foreground)] truncate">
                Pagination Infinite Dot Scrubber
              </h4>
            ...
            <p className="text-xs text-[var(--muted-foreground)] line-clamp-1 mt-0.5">
              Carousel micro-dot pagination with magnetic active expansion indicator.
            </p>
          </div>
        </div>
