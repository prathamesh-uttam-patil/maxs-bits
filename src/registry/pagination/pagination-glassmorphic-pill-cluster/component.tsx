...
interface PaginationGlassmorphicPillClusterProps {
  className?: string;
}

export function PaginationGlassmorphicPillCluster({ className }: PaginationGlassmorphicPillClusterProps) {
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-2">
              <h4 className="text-sm font-semibold text-[var(--foreground)] truncate">
                Pagination Glassmorphic Pill Cluster
              </h4>
            ...
            <p className="text-xs text-[var(--muted-foreground)] line-clamp-1 mt-0.5">
              Frosted floating page buttons with gradient hover outlines and active glow.
            </p>
          </div>
        </div>
