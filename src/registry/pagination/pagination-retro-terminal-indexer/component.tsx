...
interface PaginationRetroTerminalIndexerProps {
  className?: string;
}

export function PaginationRetroTerminalIndexer({ className }: PaginationRetroTerminalIndexerProps) {
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-2">
              <h4 className="text-sm font-semibold text-[var(--foreground)] truncate">
                Pagination Retro Terminal Indexer
              </h4>
            ...
            <p className="text-xs text-[var(--muted-foreground)] line-clamp-1 mt-0.5">
              ASCII terminal styled pagination bar with bracket controls and monospace index.
            </p>
          </div>
        </div>
