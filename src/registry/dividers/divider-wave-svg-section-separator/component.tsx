...
interface DividerWaveSvgSectionSeparatorProps {
  className?: string;
}

export function DividerWaveSvgSectionSeparator({ className }: DividerWaveSvgSectionSeparatorProps) {
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-2">
              <h4 className="text-sm font-semibold text-[var(--foreground)] truncate">
                Divider Wave SVG Section Separator
              </h4>
            ...
            <p className="text-xs text-[var(--muted-foreground)] line-clamp-1 mt-0.5">
              Organic smooth wave curve separating page sections with soft transition gradient.
            </p>
          </div>
        </div>
