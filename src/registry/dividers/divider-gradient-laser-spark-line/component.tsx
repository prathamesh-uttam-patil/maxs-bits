...
interface DividerGradientLaserSparkLineProps {
  className?: string;
}

export function DividerGradientLaserSparkLine({ className }: DividerGradientLaserSparkLineProps) {
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-2">
              <h4 className="text-sm font-semibold text-[var(--foreground)] truncate">
                Divider Gradient Laser Spark Line
              </h4>
            ...
            <p className="text-xs text-[var(--muted-foreground)] line-clamp-1 mt-0.5">
              High energy laser separator with bright center sparkle and glowing taper.
            </p>
          </div>
        </div>
