...
interface DividerCenterIconBadgeBreakProps {
  className?: string;
}

export function DividerCenterIconBadgeBreak({ className }: DividerCenterIconBadgeBreakProps) {
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-2">
              <h4 className="text-sm font-semibold text-[var(--foreground)] truncate">
                Divider Center Icon Badge Break
              </h4>
            ...
            <p className="text-xs text-[var(--muted-foreground)] line-clamp-1 mt-0.5">
              Clean subtle divider with embedded center pill badge and decorative icon.
            </p>
          </div>
        </div>
