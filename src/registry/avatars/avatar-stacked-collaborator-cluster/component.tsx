...
interface AvatarStackedCollaboratorClusterProps {
  className?: string;
}

export function AvatarStackedCollaboratorCluster({ className }: AvatarStackedCollaboratorClusterProps) {
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-2">
              <h4 className="text-sm font-semibold text-[var(--foreground)] truncate">
                Avatar Stacked Collaborator Cluster
              </h4>
            ...
            <p className="text-xs text-[var(--muted-foreground)] line-clamp-1 mt-0.5">
              Overlapping team avatar pile with +N overflow bubble and hover elevation.
            </p>
          </div>
        </div>
