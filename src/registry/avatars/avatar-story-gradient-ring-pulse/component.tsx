...
interface AvatarStoryGradientRingPulseProps {
  className?: string;
}

export function AvatarStoryGradientRingPulse({ className }: AvatarStoryGradientRingPulseProps) {
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-2">
              <h4 className="text-sm font-semibold text-[var(--foreground)] truncate">
                Avatar Story Gradient Ring Pulse
              </h4>
            ...
            <p className="text-xs text-[var(--muted-foreground)] line-clamp-1 mt-0.5">
              Instagram style active story ring with spinning multicolored gradient boundary.
            </p>
          </div>
        </div>
