...
interface AvatarVerifiedCreatorShieldProps {
  className?: string;
}

export function AvatarVerifiedCreatorShield({ className }: AvatarVerifiedCreatorShieldProps) {
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-2">
              <h4 className="text-sm font-semibold text-[var(--foreground)] truncate">
                Avatar Verified Creator Shield
              </h4>
            ...
            <p className="text-xs text-[var(--muted-foreground)] line-clamp-1 mt-0.5">
              Profile photo with glowing verified checkmark shield badge and VIP label.
            </p>
          </div>
        </div>
