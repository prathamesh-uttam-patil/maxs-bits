...
interface Avatar3dHologramCyberFrameProps {
  className?: string;
}

export function Avatar3dHologramCyberFrame({ className }: Avatar3dHologramCyberFrameProps) {
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-2">
              <h4 className="text-sm font-semibold text-[var(--foreground)] truncate">
                Avatar 3D Hologram Cyber Frame
              </h4>
            ...
            <p className="text-xs text-[var(--muted-foreground)] line-clamp-1 mt-0.5">
              Sci-fi holographic avatar portrait with glowing scanline grid overlay.
            </p>
          </div>
        </div>
