...
interface TooltipMicroSurveyRatingProps {
  className?: string;
}

export function TooltipMicroSurveyRating({ className }: TooltipMicroSurveyRatingProps) {
        ...
        <div className="flex items-center gap-3 min-w-0">
          ...
          <div className="min-w-0">
            ...
            <p className="text-xs text-[var(--muted-foreground)] line-clamp-1 mt-0.5">
              In-context feedback popup with 5-star quick rating and submit trigger.
            </p>
          </div>
        </div>
