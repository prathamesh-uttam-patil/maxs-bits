...
interface TooltipCurrencyExchangeCalculatorProps {
  className?: string;
}

export function TooltipCurrencyExchangeCalculator({ className }: TooltipCurrencyExchangeCalculatorProps) {
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-2">
              <h4 className="text-sm font-semibold text-[var(--foreground)] truncate">
                Tooltip Currency Exchange Calculator
              </h4>
            ...
            <p className="text-xs text-[var(--muted-foreground)] line-clamp-1 mt-0.5">
              Dynamic hover calculator showing converted international currencies in realtime.
            </p>
          </div>
        </div>
