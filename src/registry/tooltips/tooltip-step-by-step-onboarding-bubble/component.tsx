...
interface TooltipStepByStepOnboardingBubbleProps {
  className?: string;
}

export function TooltipStepByStepOnboardingBubble({ className }: TooltipStepByStepOnboardingBubbleProps) {
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-2">
              <h4 className="text-sm font-semibold text-[var(--foreground)] truncate">
                Tooltip Step by Step Onboarding Bubble
              </h4>
            ...
            <p className="text-xs text-[var(--muted-foreground)] line-clamp-1 mt-0.5">
              Guided tour pointer bubble with next/prev buttons and step tracker.
            </p>
          </div>
        </div>
