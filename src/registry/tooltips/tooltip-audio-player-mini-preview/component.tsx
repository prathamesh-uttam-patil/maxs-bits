...
interface TooltipAudioPlayerMiniPreviewProps {
  className?: string;
}

export function TooltipAudioPlayerMiniPreview({ className }: TooltipAudioPlayerMiniPreviewProps) {
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-2">
              <h4 className="text-sm font-semibold text-[var(--foreground)] truncate">
                Tooltip Audio Player Mini Preview
              </h4>
            ...
            <p className="text-xs text-[var(--muted-foreground)] line-clamp-1 mt-0.5">
              Track hover card with mini play/pause wave scrubber and artist info.
            </p>
          </div>
        </div>
