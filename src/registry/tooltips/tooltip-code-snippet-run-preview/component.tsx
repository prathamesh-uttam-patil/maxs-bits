...
interface TooltipCodeSnippetRunPreviewProps {
  className?: string;
}

export function TooltipCodeSnippetRunPreview({ className }: TooltipCodeSnippetRunPreviewProps) {
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-2">
              <h4 className="text-sm font-semibold text-[var(--foreground)] truncate">
                Tooltip Code Snippet Run Preview
              </h4>
            ...
            <p className="text-xs text-[var(--muted-foreground)] line-clamp-1 mt-0.5">
              Code explanation hover card with live execution output indicator.
            </p>
          </div>
        </div>
